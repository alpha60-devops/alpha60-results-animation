...
reviewed Animation universe AND Superhero genre or reviewed Spider-Man slice.
...
{% include mellon-6/runs/2017-2026-itu-2025/superhero-animation-media-objects-table.html %}
...
- [Exclusions JSON](../../data/mellon-6/runs/2017-2026-itu-2025/superhero-animation-exclusions.json)
